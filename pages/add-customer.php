    ...
    if(isset($_GET['q']))
    {
        if($_GET['q']=='success'){
            echo"<div class='alert alert-success '>
                                            <button class='close' data-close='alert'></button> The data is successfully added! </div>";
        }else if($_GET['q']=='error'){
            if($_GET['status']=='customer'){
                echo"<div class='alert alert-danger '>
                                            <button class='close' data-close='alert'></button> Customer exist already exits.</div>";
            }
        }
    }
?>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Customer Email
                                                    <span class="required"> * </span>
                                                </label>
                                            <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input name="customer_contact" type="text" class="form-control" placeholder="Customer Contact No" /> </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3">GST No <span class="required"> * </span></label>
                                            <div class="col-md-4">
                                                <input name="customer_gst_no" type="text" class="form-control" placeholder="GST No" /> </div>
                                        </div>
                                    </div>
