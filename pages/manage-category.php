...
<![endif]-->
    ...
    <!-- END CORE PLUGINS -->
    <!-- BEGIN PAGE LEVEL PLUGINS -->
    <script src="../assets/gloabal/plugins/bootstrap-toastr/toastr.min.js"></script>
    ...
    <?php
        if(isset($_SESSION['status']) && $_SESSION['status'] == EDIT_STATUS_SUCCESS) {
    ?>
    <script>
        toastr.options = {
            "closeButton": true,
        ...
        toastr["success"]("You updated the category name sucesfully.", "Category Edit");
    </script>
    <?php
            unset($_SESSION['status']);
        }
    ?>
    <!--SCRIPT FOR TOASTR SUCCESS -->
    <!-- END OF SCRIPT FOR TOASTR -->
</body>
